...
export default function Home() {
  return (
    <main className="flex-1">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-background to-background/80 py-12 md:py-20 lg:py-32">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
              ...
              AI tools help you master any subject faster.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-background rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Generate AI-powered flashcards from your notes, textbooks, or
            ...
            <div className="bg-background rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Transform lengthy documents into concise, easy-to-understand
            ...
            <div className="bg-background rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Share your study materials with others and earn rewards for your
                contributions.
              </p>
              <Link
      ...
      <section className="py-12 md:py-16 lg:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-gradient-to-br from-primary/20 to-primary/5 rounded-2xl p-6 md:p-10 lg:p-12 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4">
              Ready to Transform Your Learning?
            </h2>
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto mb-6 md:mb-8">
              Join thousands of students who are already using Acharya to
